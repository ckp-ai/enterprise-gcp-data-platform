# ADR-1203: Use BigQuery managed disaster recovery or tested cross-region replication for critical datasets

- **ADR ID:** ADR-1203
- **Decision title:** Use BigQuery managed disaster recovery or tested cross-region replication for critical datasets
...
- **Problem:** Critical analytics and data products require regional recovery of data and compute.
...
- **Alternatives considered:** Snapshots only, Manual export/import, Managed DR or governed replication by workload.
...
- **Decision:** Use BigQuery Managed DR where edition, region pair and workload fit; otherwise use tested cross-region dataset replication plus explicit compute and consumer cutover procedures.
- **Rationale:** Provides a supported path for regional outages while retaining alternatives where capability or commercial fit differs.

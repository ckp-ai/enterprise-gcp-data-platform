# ADR-1210: Require periodic end-to-end exercises and evidence-based risk acceptance

- **ADR ID:** ADR-1210
- **Decision title:** Require periodic end-to-end exercises and evidence-based risk acceptance
...
- **Problem:** Untested backups and runbooks provide false confidence.
...
- **Alternatives considered:** Documentation review only, Ad hoc tests, Risk-based recurring exercise program.
...
- **Decision:** Test restores quarterly, conduct Tier 0/1 table-tops semiannually, execute regional and cyber exercises at least annually, and track findings to closure or formal acceptance.
- **Rationale:** Turns DR capability into measurable operational evidence.
